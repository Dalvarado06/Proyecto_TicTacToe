...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/tictactoe_12011159.exe
...
${OBJECTDIR}/AdminJugadores.o: AdminJugadores.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/AdminJugadores.o AdminJugadores.cpp
...
${OBJECTDIR}/GuardarPvP.o: GuardarPvP.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/GuardarPvP.o GuardarPvP.cpp

${OBJECTDIR}/GuardarVsCpu.o: GuardarVsCpu.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/GuardarVsCpu.o GuardarVsCpu.cpp

${OBJECTDIR}/HistorialJugadas.o: HistorialJugadas.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/HistorialJugadas.o HistorialJugadas.cpp
...
${OBJECTDIR}/JuegoCpu.o: JuegoCpu.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/JuegoCpu.o JuegoCpu.cpp
...
${OBJECTDIR}/PlayerCPU.o: PlayerCPU.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/PlayerCPU.o PlayerCPU.cpp

${OBJECTDIR}/PlayerHumano.o: PlayerHumano.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/PlayerHumano.o PlayerHumano.cpp

${OBJECTDIR}/SymCharMatrix.o: SymCharMatrix.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SymCharMatrix.o SymCharMatrix.cpp
