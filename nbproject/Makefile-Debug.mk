...
${OBJECTDIR}/AdminJugadores.o: AdminJugadores.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/AdminJugadores.o AdminJugadores.cpp
...
${OBJECTDIR}/GuardarPartida.o: GuardarPartida.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/GuardarPartida.o GuardarPartida.cpp
...
${OBJECTDIR}/JuegoPvP.o: JuegoPvP.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/JuegoPvP.o JuegoPvP.cpp
